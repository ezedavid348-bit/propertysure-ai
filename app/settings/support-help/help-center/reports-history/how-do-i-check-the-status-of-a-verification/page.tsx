...
export default function CheckVerificationStatusArticle() {
      ...
      <div className={styles.layout}>
        ...
        <article className={styles.article}>
          ...
          <header className={styles.articleHeader}>
            ...
            <p>
              Learn how to check the current status of a
              PropertySure AI property verification.
            </p>
          ...
          >
            <div className={styles.contentText}>
              <p className={styles.mainParagraph}>
                PropertySure AI allows you to check the status
                of a property verification from your Reports
                &amp; History section. The status helps you
                understand whether a verification is still
                being processed, has been completed, or
                requires further attention.
              </p>

              <p>
                Checking the status is useful when you have
                submitted a property document package and want
                to know whether the verification results are
                ready to review.
              </p>
              ...
              >
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    ...
                    <p>
                      ...
                      section to view your verification
                      activity.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    <h3>
                      Find the Property Verification
                    </h3>

                    <p>
                      Locate the verification for the property
                      or document package you want to check.
                      You can use the available verification
                      details to identify the correct record.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    ...
                    <p>
                      Open the verification record and review
                      the status shown for that verification.
                      The status indicates the current stage of
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    ...
                    <p>
                      ...
                      check the record again later for an
                      updated status. If it is complete, open
                      the available report to review the
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    ...
                    <p>
                      When the verification is complete, review
                      the available report and its findings
              ...
              >
                ...
                <p>
                  ...
                  A status reflects the current stage of the
                  verification process. A verification that is
                  still processing may not yet have a completed
                  report available, while a completed status
                  indicates that the available verification
              ...
              <ul className={styles.checkList}>
                <li>
                  ...
                  A verification that is still processing may
                  not have a completed report available yet.
                </li>
                ...
                <li>
                  ...
                  Check that you are viewing the status for
                ...
                <li>
                  ...
                  Review the complete report when the
                  verification is marked as completed.
                </li>
                ...
                <li>
                  ...
                  A completed verification provides findings
              ...
              >
                ...
                <p>
                  ...
                  A verification status only indicates the
                  current stage of the verification process. It
                  does not by itself guarantee that a property
                  is completely safe, legally perfect, or
                  fraud-free. Review the report findings
          ...
          <section className={styles.sideCard}>
            ...
            <nav className={styles.articleNav}>
              ...
              <button
                type="button"
                onClick={() =>
                  scrollToSection("status-meaning")
                }
              >
