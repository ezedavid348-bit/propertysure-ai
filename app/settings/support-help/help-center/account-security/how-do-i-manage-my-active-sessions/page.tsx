...
import styles from "./how-do-i-manage-my-active-sessions.module.css";
...
export default function ManageActiveSessionsArticle() {
      ...
      <div className={styles.layout}>
        ...
        <article className={styles.article}>
          ...
          <header className={styles.articleHeader}>
            ...
            <p>
              Learn how to review and manage the devices and
              sessions currently connected to your
          ...
          >
            <div className={styles.contentText}>
              ...
              <p className={styles.mainParagraph}>
                Active sessions show the devices and browser
                sessions currently connected to your
                PropertySure AI account.
              </p>

              <p>
                Reviewing your active sessions regularly can
                help you identify unfamiliar activity and
              ...
              <h2>
                Steps to Manage Your Active Sessions
              </h2>
              ...
              >
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    ...
                    <p>
                      Open your account settings and go to
                      the security section where your active
                      sessions and connected devices are
                      managed.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    ...
                    <p>
                      Review the devices, browsers, locations,
                      and recent activity associated with
                      your account.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    <h3>
                      Identify Unfamiliar Activity
                    </h3>

                    <p>
                      Check the listed sessions carefully and
                      look for devices, locations, or activity
                ...
                <div className={styles.processItem}>
                  ...
                  <div className={styles.processContent}>
                    <h3>
                      Sign Out of Unwanted Sessions
                    </h3>

                    <p>
                      Select the option to sign out or remove
                      access from any device or session that
              ...
              >
                ...
                <p>
                  <strong>Security check complete.</strong>{" "}
                  Removing unfamiliar or unused sessions
                  helps keep your PropertySure AI account
                  secure.
                </p>
              </div>
              ...
              <ul className={styles.checkList}>
                ...
                <li>
                  ...
                  Pay attention to unfamiliar locations or
                  devices.
                </li>
                ...
                <li>
                  ...
                  Change your password if you suspect
                  unauthorized access.
                </li>
              </ul>
              ...
              >
                ...
                <p>
                  ...
                  If you notice a session or device that you
                  do not recognize, sign it out immediately
                  and consider changing your password. If
                  necessary, enable two-factor authentication
